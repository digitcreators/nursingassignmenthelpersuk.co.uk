    ...
    <section>
        <div class="lg:mx-12 py-5">
            <div class="container mx-auto px-4 pb-4">
                ...
                <hr class="border border-primary-one bg-pri w-full h-[0.35rem] my-3 mx-auto" style="background:#00018a;">
            </div>
            <div class="mx-auto">
                <div class=" px-4 space-y-4 ">
                    <div class="border rounded-2xl max-w-sm mx-auto bg-white"
                        style="box-shadow: 0 0 15px 0px #00018a;">
                        <h4
                        ...
                        <div class="w-full px-6 py-4">
                            <a href="{{ url('https://checkout.cheapresumewriter.com/payment?reference=' . $invoice->ref_no . '&gateway=stripe&source=nursing-ahuk') }}"
